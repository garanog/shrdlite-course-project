...
In the following decennials many companies tried to add various sensors in the roads. They were able to sense the presence of any vehicle and would send information to that vehicles autopilot \cite{Courier1960Driverless}.
...
With development led by Stanford University and Volkswagen Stanley was designed for a static environment and would be able to travel on populated roads. Despite that, the technology of Stanley was in many ways similar to the technology of the autonomous vehicles of today \cite{Thrun2006stanley}.
