...
\subsection{History}
Throughout history man has tried to create a self driving car using very different technologies. As early as 1926 a driverless car drove the streets of Milwaukee. At the time the car had to be radio-controlled from a following car. %TODO \cite{The Milwaukee Sentinel:26}

In the following decennials many companies tried to add various sensors in the roads. They were able sense the presence of any vehicle and would send information to that vehicles autopilot. %TODO \cite{Press-Courier:60}
...
The majority of car companies are today researching autonomous vehicles and early 2014 Induct started selling Navia, the first commercial self driving car. %TODO \cite{eWeek:14}
...
exactly how people have programed them. While they are far from perfect Google has gone very far to make them ateast as
