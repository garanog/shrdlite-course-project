...
var grammar = {
    ...
    {"name": "main", "symbols": ["main$ebnf$1", "main$ebnf$2", "command", "main$ebnf$3"], "postprocess": R({type:"command", command:2})},
    ...
    {"name": "main", "symbols": ["main$ebnf$4", "question", "main$ebnf$5"], "postprocess": R({type:"question", question:1})},
